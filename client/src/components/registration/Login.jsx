...
import { signInWithGooglePopup } from "../../utils/firebaseAuthProvider";
...
export default function Login() {
    ...
    if (!password.trim()) {
      ...
      if (success) {
        if (data.role !== "NO_ROLE") {
          ...
          navigate(
            `/choose?user=${data.username}&email=${data.email}&token=${data.accessToken}&id=${data._id}`
          );
        }
      } else {
  ...
  const handleGoogleSignin = async () => {
    ...
    saveUserInfo(token, { username, email });
  };
