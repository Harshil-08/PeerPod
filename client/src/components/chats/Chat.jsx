		...
		>
			<div className="flex flex-row items-center">
				<div className="flex items-center justify-center h-8 w-8 rounded-full bg-[#F3F4F6] dark:bg-[#171717] text-gray-50 flex-shrink-0">
					{showSenderInfo && (
						<img
							...
							onClick={() => navigate(`/profile?id=${message.sender._id}`)}
				...
				>
					{showSenderInfo && (
						<span
							className="text-sm text-violet-500 ml-2 dark:text-indigo-300 cursor-pointer"
							onClick={() => navigate(`/profile?id=${message.sender._id}`)}
						>
					...
					<div
						className={`relative ml-2 text-sm py-3 px-3 ${!message.deleted ? "shadow bg-white dark:bg-[#262626]" : "bg-[#F3F4F6] dark:bg-[#171717]"} rounded-xl dark:bg-neutral-800`}
						onClick={() =>
